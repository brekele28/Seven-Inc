    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 p-3 sm:p-4 backdrop-blur-sm">
            ...
            >
                <div
                    className="
                        relative border-b border-red-100
                        bg-gradient-to-br from-white via-red-50 to-white
                        p-5 sm:p-6 lg:p-7
                    "
                >
                    <div className="absolute right-0 top-0 h-24 w-24 sm:h-28 sm:w-28 lg:h-32 lg:w-32 rounded-full bg-red-100/50 blur-3xl" />
                    ...
                    <div className="relative flex items-start justify-between gap-3 sm:gap-4">
                        <div className="flex min-w-0 items-start gap-3 sm:gap-4">
                            ...
                            <div className="min-w-0">
                                <p className="text-[9px] sm:text-[10px] lg:text-[11px] font-black uppercase tracking-[0.25em] sm:tracking-[0.35em] text-red-600">
                                    Warning Action
                                </p>
                ...
                <div className="p-5 sm:p-6 lg:p-7">
                    <p className="text-[14px] sm:text-[15px] leading-relaxed text-neutral-700">
                        Apakah Anda yakin ingin menghapus seluruh perubahan pada
                        halaman tampilan E-Recruitment?
                    </p>

                    <div className="mt-5 rounded-2xl border border-red-100 bg-red-50 p-4">
                        <p className="text-[12px] sm:text-[13px] leading-relaxed text-red-700">
                            Semua data yang telah diubah akan dikembalikan ke
                            konfigurasi awal dan perubahan yang belum disimpan
                            akan hilang.
                        </p>
                    </div>
